...
Skills are multi-tool workflows that fulfill user intents.
...
| [category-exploration](category-exploration.md) | Understand domain concepts | `category_search` → `list_concepts_in_category` |
...
1. Read skill file for detailed guidance
2. Follow tool sequence
