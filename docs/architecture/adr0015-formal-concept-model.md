...
**Sources:**
- Planning: .ai/planning/2025-11-13-concept-extraction-enhancement/
...
**The Core Problem:** What exactly IS a concept in the concept-RAG system, and how do we ensure all LLM agents extract concepts consistently? [Planning: `.ai/planning/2025-11-13-concept-extraction-enhancement/FORMAL_CONCEPT_DEFINITION.md`]
