...
**The Core Problem:** How to add EPUB support while maintaining the same concept extraction and search quality as PDFs? [Planning: `.ai/planning/2025-11-15-ebook-format-support/01-implementation-plan.md`]
